...
import com.fatesg.syspdv_backend.model.*;
...
public class MovimentacaoEstoqueService {
    ...
    public List<MovimentacaoEstoque> buscarPorProdutoEPeriodo(Long produtoId, LocalDateTime dataInicio, LocalDateTime dataFim) {
        return movimentacaoRepository.findByProdutoIdAndDataHoraBetweenOrderByDataHoraDesc(produtoId, dataInicio, dataFim);
    }
}